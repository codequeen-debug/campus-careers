...
export default function BrowseJobs() {
  ...
  const [jobs, setJobs] = useLocalStorage("recruiter_jobs", mockJobs);
                      ...
                      <div onClick={e => e.stopPropagation()} style={{ display: "flex", flexDirection: "column", gap: 6, alignItems: "flex-end" }}>
                        {isPrivileged ? (
                          <>
                            ...
                            <button onClick={() => deleteJob(job.id)} style={{ padding: "5px 14px", background: "#fff5f8", border: "1px solid #ffb6c1", color: "#d4818d", borderRadius: 6, fontSize: 12, cursor: "pointer", whiteSpace: "nowrap" }}>
                              Delete
                            </button>
                          </>
                        ) : (
                          <>
                            ...
                            <button
                              ...
                              disabled={isApplied}
                              style={{ padding: "5px 14px", background: isApplied ? "#f0fdf4" : "#98fb98", border: "none", color: isApplied ? "#166534" : "#000", borderRadius: 6, fontSize: 12, cursor: isApplied ? "default" : "pointer", fontWeight: 600, whiteSpace: "nowrap" }}
                            >
            ...
            <div style={{ background: "#fff", borderRadius: 12, border: "1px solid #ffebf1", padding: 28, alignSelf: "flex-start", position: "sticky", top: 20 }}>
              ...
              {isPrivileged ? (
                <div style={{ display: "flex", gap: 10 }}>
                  ...
                  <button onClick={() => deleteJob(selectedJob.id)} style={{ flex: 1, padding: "10px", background: "#fff5f8", border: "1px solid #ffb6c1", color: "#d4818d", borderRadius: 8, fontSize: 13, cursor: "pointer", fontWeight: 600 }}>
                    Delete
                  </button>
                </div>
              ) : (
                <div style={{ display: "flex", gap: 10 }}>
                  <button
                    ...
                    style={{
                      flex: 1, padding: "10px",
                      background: savedJobs.includes(selectedJob.id) ? "#fff5f8" : "#fff",
                      border: `1px solid ${savedJobs.includes(selectedJob.id) ? "#ffb6c1" : "#ffebf1"}`,
                      color: savedJobs.includes(selectedJob.id) ? "#d4818d" : "#64748b",
                  ...
                  <button
                    ...
                    style={{
                      flex: 1, padding: "10px",
                      background: appliedJobs.includes(selectedJob.id) ? "#f0fdf4" : "#98fb98",
                      border: "none",
                      color: appliedJobs.includes(selectedJob.id) ? "#166534" : "#000",
